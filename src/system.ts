...
function createRandomSatellite(parent: Satellite | null = null) {
    const p = {
        ...
        semiMajorAxis: parent != null ? getRandomRange(5, 10) : getRandomRange(10, 300),
    ...
    const geometry = new THREE.SphereGeometry(parent == null ? getRandomRange(0.5, 3) : getRandomRange(0.1, 0.5), 100, 100);
    const material = new THREE.MeshStandardMaterial({ color: parent == null ? 0x0000ff : 0xff0000 });
